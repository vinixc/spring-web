		...
		<ul class="clearfix book-collection">
			...
			<c:forEach items="${produtos }" var="produto">
				<li>
					...
					<img width="143" height="202" src="https://cdn.shopify.com/s/files/1/0155/7645/products/p_3eab0589-f7b9-459d-97f9-81001739d03e_large.jpg?v=1581102263" alt="Java 8 Prático" title="Java 8 Prático" /> 
